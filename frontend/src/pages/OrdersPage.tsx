...
export function OrdersPage() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <Text size="xl" fw={700} c="white" mb="xl">
        Trading History
      </Text>
        ...
        <Center h={400}>
          <Stack align="center" gap="md">
            ...
            <Text size="sm" c="dimmed" ta="center" maw={400}>
              The Orders IDE has been removed in favor of an orchestrator architecture. Trading
              history and analytics will be available once the orchestrator is implemented.
            </Text>
          </Stack>
        </Center>
      </Paper>
