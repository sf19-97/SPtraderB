...
function getPopoverMiddlewares(options, getFloating, env2) {
  ...
  if (options.dropdownVisible && env2 !== "test") {
...
var varsResolver65 = createVarsResolver((_, { size: size4 }) => ({
  root: {
    "--pin-input-size": getSize(size4 ?? "md", "pin-input-size")
  }
}));
  ...
  return (0, import_jsx_runtime336.jsxs)(
    "li",
    {
      ...
      children: [
        ...
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime336.jsx)("ul", { role: "group", ...getStyles2("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-R7K2E356.js.map
